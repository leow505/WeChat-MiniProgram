 ...
 *
 * KEEP IN SYNC with cloudfunctions/api/lib/rules.js — a cloud function only
 ...
 *
 * The client uses these to render and to disable buttons. The server uses its
 * copy to authorize. Never trust the client's answer.
 */
