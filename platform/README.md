...
npm run test:server      # 131 — against a real PostgreSQL
...
node tests/organizer.test.js   #  39  a live session's rules and club money
node tests/i18n.test.js        # 391  every label exists, and is rendered
```
